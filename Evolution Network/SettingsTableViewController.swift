...
class SettingsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            cell.setupSlider(title: "Mutation rate",min: 0, max: 5, value: Float(Global.data.mutationRate), IsRounded: false)
            cell.valueUpdated = { value in
            ...
            cell.setupSlider(title: "Delay",min: 0, max: 0.3, value: Float(Global.data.simDelay), IsRounded: false)
            cell.valueUpdated = { value in
